  ...
  return (
    <section id="catalog" className="py-20 bg-stone-50 border-t border-b border-gold-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <div className="inline-flex items-center gap-1 text-xs text-maroon-800 font-display font-semibold uppercase bg-maroon-50 px-3 py-1 rounded-full mb-4 border border-gold-200">
        ...
        <div className="flex justify-center gap-3 mb-12">
          <button
            ...
            className={`px-5 py-2 rounded-full font-display text-xs uppercase tracking-wider font-semibold border transition-all ${
              activeCategory === 'all'
                ? 'bg-maroon-800 border-maroon-800 text-stone-50 shadow-sm'
            ...
            >
              ...
              <div className="relative aspect-[4/3] bg-stone-100 overflow-hidden border-b border-stone-100">
                ...
                <span className={`absolute top-3 right-3 text-[9px] font-display uppercase font-bold tracking-wider px-2 py-1 rounded shadow-sm ${
                  prod.type === 'machine' ? 'bg-maroon-800 text-white' : 'bg-gold-200 text-gold-900 border border-gold-400'
                }`}>
        ...
        {/* Dynamic call-out */}
        <ScrollReveal className="mt-12 bg-maroon-800 text-stone-100 p-6 sm:p-8 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-6 stitch-border border-gold-400">
          ...
          <a
            href="#contact"
            className="bg-white text-maroon-900 font-display font-semibold text-xs py-3 px-6 rounded-full hover:bg-gold-50 uppercase tracking-widest shadow transition-transform active:scale-95 shrink-0"
          >
            Get Custom Quote
          </a>
        </ScrollReveal>
